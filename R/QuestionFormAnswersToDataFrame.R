...
function (xml = NULL, xml.parsed = NULL) 
{
    ...
    for (i in 1:iterations) {
        ...
        if (length(xmlChildren(questions[[z]])$QuestionIdentifier) == 
            1) 
        ...
        if (length(xmlChildren(questions[[z]])$FreeText) == 1) {
        ...
        else if (length(xmlChildren(questions[[z]])$UploadedFileKey) == 
            1) {
        ...
        else if (length(xmlChildren(questions[[z]])$SelectionIdentifier) == 
            1) {
            ...
            if (length(xmlChildren(questions[[z]])$OtherSelectionField) == 
                1) 
        ...
        else if (length(xmlChildren(questions[[z]])$OtherSelectionField) == 
            1) {
